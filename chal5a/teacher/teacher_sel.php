...
<h3 for="act"> <?php
    ...
    ?>Đây là thông tin của tất cả học sinh:</h3>
...
if ($res = mysqli_query($conn, $sql)) {
    if (mysqli_num_rows($res) > 0) {
        ...
        while ($row = mysqli_fetch_array($res)) {
            ...
            echo "<td>".$row['user_student']."</td>";
            echo "<td>".$row['pass_student']."</td>";
            echo "<td>".$row['fullname_student']."</td>";
            echo "<td>".$row['email_student']."</td>";
            echo "<td>".$row['phone_student']."</td>";
            echo "</tr>";
        }
        echo "</table>";
