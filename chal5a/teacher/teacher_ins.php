...
<h3 for="act"> <?php
    ...
    ?>Nhập thông tin sinh viên muốn thêm:</h3>
<div>
    <form method="POST" action="teacher_ins.php">
        <div class="row">
            <div class="col">
        ...
        <div class="btn-group" role="group" aria-label="Basic outlined example">
            ...
            <button id='submit' type="submit" name = 'ins_submit' class="btn btn-outline-secondary">Gửi</button>
        </div>
    </form>
</div>
...
if (isset($_POST["ins_submit"])) {
    ...
    if ($id == "" || $fullname =="" || $user ==""|| $pass == "" || $email == "" || $phone == "" || $position == "") {
        ...
        $sql1 = "INSERT INTO infor_student(ID_student, user_student, pass_student, fullname_student, email_student, phone_student) VALUES ('$id','$user','$pass','$fullname','$email','$phone')";
        $query1 = mysqli_query($conn,$sql1);
        $sql2 = "INSERT INTO user(ID, username, password, email, position ) VALUES ('$id', '$user', '$pass', '$email', '$position')";
